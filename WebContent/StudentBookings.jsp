...
<body>
	...
	<div style="text-align: center;">
		<a href="?studentid=${param.studentid}&date=${prevmonth}"
			type="button">上個月(<fmt:formatDate value="${prevmonth}"
				pattern="yyyy-MM" />)
		</a> <a href="?studentid=${param.studentid}" type="button">本月(<fmt:formatDate
				value="${now}" pattern="yyyy-MM" />)
		</a> <a href="?studentid=${param.studentid}&date=${nextmonth}"
			type="button">下個月(<fmt:formatDate value="${nextmonth}"
				pattern="yyyy-MM" />)
		</a>
		<hr>
		<%-- 		<h1>
 ...
 --%>
		...
		<div style="font-size: 1.6em;">
			<span id="studentid">${param.studentid}</span> 座位<input name="seatid"
				type="text" value="${param.seatid}" />號
		</div>
		<div id="css_table">
			<div class="css_tr">
